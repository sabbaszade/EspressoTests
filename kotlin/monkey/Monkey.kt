...
import ir.part.app.signal.monkey.PackageInfo.launchPackage
import ir.part.app.signal.monkey.PackageInfo.shouldRelaunchTheApp
...
object Monkey {
    ...
    fun run(actionsCount: Int, packageName: String = toDoAppPackageName) {
        ...
        loop@ for (i in 0..actionsCount) {
            ...
            if (shouldRelaunchTheApp(monkeyAction, packageName)) {
