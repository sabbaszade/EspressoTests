...
fun dataInstanceOf(clazz: Class<*>): DataInteraction =
    Espresso.onData(CoreMatchers.instanceOf(clazz))
...
fun ViewInteraction.checkDisplayed(): ViewInteraction =
    wait().check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
...
fun ViewInteraction.actionOnItem(
...
fun ViewInteraction.wait(): ViewInteraction =
    ConditionWatchers.waitForElement(this, TEN_SECONDS)


fun ViewInteraction.waitForGone(): ViewInteraction =
    ConditionWatchers.waitForElementIsGone(this, TEN_SECONDS)
